...
Window {
    ...
    Rectangle {
        ...
        Rectangle { id: onElement; x: 25; y: 15; width: 100; height: 100 }
        Rectangle { id: offElement; x: 25; y: 135; width: 100; height: 100 }
        ...
        transitions: [
            Transition {
                from: "off"; to: "on"
                PropertyAnimation { target: onElement; properties: "color"; duration: 1000 }
            },
            Transition {
                from: "on"; to: "off"
                PropertyAnimation { target: offElement; properties: "color"; duration: 1000 }
            }
        ]
    }
}